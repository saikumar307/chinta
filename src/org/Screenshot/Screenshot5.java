...
public class Screenshot5 {
	public static void main(String[] args) throws  IOException {
		...
		WebElement enter = driver.findElement(By.xpath("(//div[@data-toggle='collapse'])[12]"));
		enter.click();
		...
		File dess = new File("C:\\Users\\chsai\\eclipse-workspace\\chromeBrowser\\Screenshots\\greens5.png");
